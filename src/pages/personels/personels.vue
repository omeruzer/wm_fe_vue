<template>
  <div>
    ...
    <Buttons :buttonTitle="buttonTitle" btnType="personel" @refreshData="list = $event" />
                ...
                <tbody>
                  <tr v-for="(item, index) in list" :key="index">
                    ...
                    <td class="justify-content-between">
                      {{ item.get_departman.name }}
                    </td>
                    <td>
                      <router-link
                        :to="'/personels/'+item.id"
                        ><button
