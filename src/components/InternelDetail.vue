                ...
                <div class="form-group ml-3">
                  <div class="">
                    ...
                    <div class="d-flex">
                      ...
                      <span class="ml-2">{{
                        item.internel_date.substr(0, 10)
                      }}</span>
                    </div>
                  </div>
          ...
          <div class="form-group ml-3">
            <div class="">
              ...
              <div class="d-flex">
                ...
                <span class="ml-2">{{ item.internel_date.substr(0, 10) }}</span>
              </div>
              <div class="d-flex">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="d-flex justify-content-end">
              <a :href="'http://localhost:8000/internel-pdf/'+item.id">
