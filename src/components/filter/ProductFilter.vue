        ...
        <div class="row d-flex justify-content-start align-items-center">
          <div class="col-md-2">
            <div class="form-group mb-3">
              ...
              <input class="form-control mb-3" type="text" v-model="filterw.name" name="" id="">
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group mb-3">
              <label for="">{{ $t('PRODUCT_CODE') }}</label>
              <input class="form-control mb-3" type="text" v-model="filterw.code" name="" id="">
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group mb-3">
              ...
              <select v-model="filterw.brand" class="form-control mb-3">
                <option class="" v-for="item, i in brands" :key="i" :value="item.id">{{ item.name }}</option>
              </select>
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group mb-3">
              ...
              <select id="" v-model="filterw.season" class="form-control mb-3">
                <option class="" v-for="item, i in season" :key="i" :value="item.id">{{ item.name }}</option>
              </select>
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group mb-3">
              ...
              <select id="" v-model="filterw.category" class="form-control mb-3">
                <option class="" v-for="item, i in categories" :key="i" :value="item.id">{{ item.name }}</option>
              </select>
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group mb-3">
              ...
              <select id="" v-model="filterw.pattern" class="form-control mb-3">
                <option class="" v-for="item, i in patterns" :key="i" :value="item.id">{{ item.name }}</option>
              </select>
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group mb-3">
              ...
              <select id="" v-model="filterw.material" class="form-control mb-3">
                <option class="" v-for="item, i in materials" :key="i" :value="item.id">{{ item.name }}</option>
              </select>
            </div>
          </div>
          <div class="col-md-2">
          ...
          <div class="col-md-2">
            <button class="btn btn-primary filterButton" @click="filterws">{{ $t('FILTER') }}</button>
            <button class="btn filterButton" @click="cleanFilter">{{ $t('CLEAN') }}</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    async filterws() {
      await axios.post('/api/product', this.filterw)
        .then((result) => {
